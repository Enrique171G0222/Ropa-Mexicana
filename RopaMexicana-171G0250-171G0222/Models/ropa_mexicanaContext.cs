...
{
    public partial class ropa_mexicanaContext : DbContext
    {
        public ropa_mexicanaContext()
        {
        }

        public ropa_mexicanaContext(DbContextOptions<ropa_mexicanaContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySql("server=localhost;user=root;password=root;database=ropa_mexicana", x => x.ServerVersion("5.7.18-mysql"));
            }
        }
