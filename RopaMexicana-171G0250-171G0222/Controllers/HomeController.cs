...
namespace RopaMexicana_171G0250_171G0222.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            //    ropa_mexicanaContext context = new ropa_mexicanaContext();

            //    ProductoRepository repos = new ProductoRepository(context);
            //   InicioViewModel vm = new InicioViewModel
            //    {
            //        Productos = id == null ? repos.GetProductosgg() : repos.GetProductoByLetraInicial(id),
        ...
        public IActionResult EditarDatosProducto(ProductoViewModel vm)
        {
            ...
            //if (avm.Archivo != null)
            //{
            //    if (avm.Archivo.ContentType != "image/jpeg" || avm.Archivo.Length > 1024 * 1024 * 2)
            //    {
            //        ModelState.AddModelError("", "Debe selecionar un archivo jpg de menos de 2mb");
            //        avm.MarcaAfiliadas = marcarepository.GetAll();
            ...
            //try
            //{
            //    var producto = productorepository.Get(avm.Producto.Id);
            //    if (producto != null)
            //    {
            //        producto.Nombre = avm.Producto.Nombre;
            //        producto.Costo = avm.Producto.Costo;
            //        producto.Descripción = avm.Producto.Descripción;
            //        producto.Color = avm.Producto.Color;
            //        producto.Material = avm.Producto.Material;
            //        producto.Hipervinculo = avm.Producto.Hipervinculo;

            //        productorepository.Update(producto);
            //        if (avm.Archivo != null)
            //        {
            //            FileStream fs = new FileStream(Environment.WebRootPath + "/imgs_Productos/" + avm.Producto.Id + "_0.jpg", FileMode.Create);
            //            avm.Archivo.CopyTo(fs);
            //            fs.Close();
            //        }
            ...
            //        avm.MarcaAfiliada = marcarepository.Get(avm.Producto.IdMarcaAfi);
            //        avm.MarcaAfiliadas = marcarepository.GetAll();
            //        return View(avm);
            //    }
